...
def main(task):
    """Finetune and test the model for a property task.
    Loads optional pretrain, trains, early-stops on val R2,
    saves best weights, logs metrics, and writes test predictions/results."""
